...
namespace Distance.Diagnostics.Icmp {
    ...
    public class IcmpPacket : DistanceFact {
        ...
        public static IcmpPacket Create(string[] values) {
            ...
            newObj._IcmpType = values[3].ToInt32();
            newObj._IcmpCode = values[4].ToInt32();
            newObj._IcmpIdent = values[5].ToInt32();
            newObj._IcmpSeq = values[6].ToInt32();
            return newObj;
        }
    }
